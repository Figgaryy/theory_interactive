...
const EX212_COMP = { name: '¬M (Q12)', alphabet: ['a', 'b'], start: 'q0', finals: ['q3'], rows: { q0: { a: 'q0', b: 'q1' }, q1: { a: 'q0', b: 'q2' }, q2: { a: 'q0', b: 'q3' }, q3: { a: 'q3', b: 'q3' } }, pos: { q0: [90, 200], q1: [250, 200], q2: [410, 200], q3: [570, 200] } };
const D_ABA = { name: '{aba}', alphabet: ['a', 'b'], start: 'q0', finals: ['q3'], rows: { q0: { a: 'q1', b: 'd' }, q1: { b: 'q2', a: 'd' }, q2: { a: 'q3', b: 'd' }, q3: { a: 'd', b: 'd' }, d: { a: 'd', b: 'd' } }, pos: { q0: [80, 200], q1: [220, 200], q2: [360, 200], q3: [500, 200], d: [290, 330] } };
const D_ASTAR = { name: 'aΣ*', alphabet: ['a', 'b'], start: 'q0', finals: ['q1'], rows: { q0: { a: 'q1', b: 'd' }, q1: { a: 'q1', b: 'q1' }, d: { a: 'd', b: 'd' } }, pos: { q0: [100, 200], q1: [300, 200], d: [300, 330] } };
const D_MOD3 = { name: '|ω| mod 3 = 0', alphabet: ['a', 'b'], start: 'q0', finals: ['q0'], rows: { q0: { a: 'q1', b: 'q1' }, q1: { a: 'q2', b: 'q2' }, q2: { a: 'q0', b: 'q0' } }, pos: { q0: [120, 200], q1: [300, 110], q2: [300, 290] } };
...
const D_ABA_STAR = { name: '{ab}{a}*', alphabet: ['a', 'b'], start: 'q0', finals: ['q2'], rows: { q0: { a: 'q1', b: 'd' }, q1: { b: 'q2', a: 'd' }, q2: { a: 'q2', b: 'd' }, d: { a: 'd', b: 'd' } }, pos: { q0: [80, 200], q1: [240, 200], q2: [400, 200], d: [240, 330] } };
const D_A_BB = { name: '{a}{a,b}*bb', alphabet: ['a', 'b'], start: 'q0', finals: ['q3'], rows: { q0: { a: 'q1', b: 'd' }, q1: { a: 'q1', b: 'q2' }, q2: { a: 'q1', b: 'q3' }, q3: { a: 'q1', b: 'q3' }, d: { a: 'd', b: 'd' } }, pos: { q0: [80, 200], q1: [240, 200], q2: [400, 200], q3: [560, 200], d: [80, 330] } };
const D_A_OR_B = { name: 'a* ∪ b*', alphabet: ['a', 'b'], start: 'q0', finals: ['q0', 'qa', 'qb'], rows: { q0: { a: 'qa', b: 'qb' }, qa: { a: 'qa', b: 'd' }, qb: { b: 'qb', a: 'd' }, d: { a: 'd', b: 'd' } }, pos: { q0: [100, 200], qa: [300, 100], qb: [300, 300], d: [500, 200] } };
...
const D_EMPTYSTR = { name: '{e}', alphabet: ['a', 'b'], start: 'q0', finals: ['q0'], rows: { q0: { a: 'd', b: 'd' }, d: { a: 'd', b: 'd' } }, pos: { q0: [120, 200], d: [320, 200] } };
const D_EMPTY = { name: '{}', alphabet: ['a', 'b'], start: 'q0', finals: [], rows: { q0: { a: 'q0', b: 'q0' } }, pos: { q0: [200, 200] } };
const D_DIV4 = { name: 'binary ÷ 4', alphabet: ['0', '1'], start: 'q0', finals: ['t'], rows: { q0: { 0: 't', 1: 'o' }, o: { 0: 'p', 1: 'o' }, p: { 0: 't', 1: 'o' }, t: { 0: 't', 1: 'o' } }, pos: { q0: [80, 200], o: [280, 110], p: [280, 290], t: [480, 200] } };
