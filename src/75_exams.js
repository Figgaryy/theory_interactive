...
const EX212_COMP = { name: '¬M (Q12)', alphabet: ['a', 'b'], start: 'q0', finals: ['q3'], rows: { q0: { a: 'q0', b: 'q1' }, q1: { a: 'q0', b: 'q2' }, q2: { a: 'q0', b: 'q3' }, q3: { a: 'q3', b: 'q3' } }, notes: { q0: '<b>q0</b> = b ติดกันท้ายสุด = 0 ตัว — คัดลอกจาก M ทุกอย่าง แต่<b>เอาวงคู่ออก</b> (เดิม q0 เป็น final)', q1: '<b>q1</b> = b ติดกันท้ายสุด = 1 ตัว (เอาวงคู่ออกเช่นกัน) — อ่าน a สายขาด กลับไป q0 เหมือนเดิม', q2: '<b>q2</b> = b ติดกันท้ายสุด = 2 ตัว (เอาวงคู่ออก) — อ่าน b อีกตัว = bbb', q3: '<b>q3</b> = เจอ bbb แล้ว — เดิมเป็น trap ตอนนี้กลายเป็น <b>final ตัวเดียว</b> วนตัวเองด้วย a,b (เจอ bbb แล้วรับตลอด)' }, pos: { q0: [90, 200], q1: [250, 200], q2: [410, 200], q3: [570, 200] } };
